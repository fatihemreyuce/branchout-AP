...
import { Leaf, ArrowLeft, Pencil, ImageIcon, Hash, ListOrdered } from "lucide-react";
import { useEcoPartnerById } from "@/hooks/use-eco-partners";
		...
		<div className="space-y-8">
			<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
				...
				<Button asChild className="gap-2 shrink-0 bg-brand text-brand-foreground hover:bg-brand/90">
					<Link to={`/eco-partners/${partner.id}/edit`}>
			...
			<Card className="w-full border-border/60 shadow-sm overflow-hidden">
				<CardHeader className="border-b border-border/60 bg-muted/20">
					...
					<CardDescription>Eco partner kimlik ve sıra bilgisi</CardDescription>
				</CardHeader>
